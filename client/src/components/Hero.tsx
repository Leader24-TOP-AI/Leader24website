        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 md:gap-8 mb-16 mt-12">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="relative dark:border-white/30 border-slate-500/50 overflow-hidden px-6 py-3 h-auto text-base font-medium w-full md:w-auto group shadow-md dark:shadow-white/5 shadow-slate-500/10"
            ...
            >
              ...
              <span className="absolute inset-0 dark:border dark:border-white/30 border border-slate-500/50 rounded-md opacity-100"></span>
              <span className="absolute inset-0 dark:bg-white/10 bg-slate-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
            </Button>
          </div>
        </div>
      </div>
